...
/*
Package config_service is a generated twirp stub package.
...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *config_model.Size) (*config_model.Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "config.service")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "MakeHat")
	out := new(config_model.Hat)
...
func (c *haberdasherProtobufClient) BuyHat(ctx context.Context, in *config_model.Hat) (*config_model.Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "config.service")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
...
func (c *haberdasherJSONClient) MakeHat(ctx context.Context, in *config_model.Size) (*config_model.Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "config.service")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "MakeHat")
	out := new(config_model.Hat)
...
func (c *haberdasherJSONClient) BuyHat(ctx context.Context, in *config_model.Hat) (*config_model.Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "config.service")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "BuyHat")
	out := new(config_model.Hat)
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/config.service.Haberdasher/MakeHat":
		s.serveMakeHat(ctx, resp, req)
		return
	case "/twirp/config.service.Haberdasher/BuyHat":
...
func (s *haberdasherServer) serveMakeHatJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(config_model.Size)
	...
	// Call service method
	var respContent *config_model.Hat
	func() {
		defer func() {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *config_model.Hat and nil error while calling MakeHat. nil responses are not supported"))
		return
	}
...
func (s *haberdasherServer) serveBuyHatJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(config_model.Hat)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		err = wrapErr(err, "failed to parse request json")
		s.writeError(ctx, resp, twirp.InternalErrorWith(err))
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *config_model.Hat and nil error while calling BuyHat. nil responses are not supported"))
		return
	}
